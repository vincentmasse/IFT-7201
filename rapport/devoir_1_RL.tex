...
\\
Nous avons aussi expérimenté pour connaitre l'influence de la taille du noyeau a l'intérieur du GaussianProcessRegressor et nous avons obtenu une meilleur performance avec une taille de 2 pour 5 instances différentes pour T = 1000 comme le montre la figure suivante.
